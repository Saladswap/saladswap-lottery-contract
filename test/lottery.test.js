...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.salad = await MockBEP20.deployed();
        ...
        await this.salad.transfer(bob, '2000', { from: minter });
        await this.salad.transfer(alice, '2000', { from: minter });
        await this.salad.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.salad.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.salad.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.salad.balanceOf(this.lotteryProxyAddress)).toString(), '418');
