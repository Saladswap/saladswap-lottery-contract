...
contract LotteryNFT is ERC721, Ownable {
    ...
    constructor() public ERC721("Salad Lottery Ticket", "SLT") {}
    ...
    function multiClaimReward(uint256[] memory _tokenIdsArr) external onlyOwner {
        for (uint i = 0; i < _tokenIdsArr.length; i++) {
            claimInfo[_tokenIdsArr[i]] = true;
        }
    }
